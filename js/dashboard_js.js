...
$(function(){
    ...
    $.ajax({
	url: jsconfig.baseurl+"dashboard/num-of-events",
	type: 'GET',
	async: true,
	dataType: "json",
	success: function (response) {
	    ...
	    dashboard_invoiceNumberOfEvents(response.series, response.categories)
	}
    });
 ...
 * @returns {undefined}
 */
function dashboard_invoiceNumberOfEvents(data,categories ){
    $('#chart_count_events').highcharts({
    chart: {
        type: 'column'
    },
    title: {
...
function dashboard_invoiceCashFlow(data,categories ){

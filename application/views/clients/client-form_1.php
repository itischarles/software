...
<div class="container-fluid bg-gray-light">
	...
	<?php endif;?>
        ...
        <div class="form-group  required">	    
	     <label for="adviserID" class="col-sm-3 control-label">Adviser</label>
	   
	     <div class="col-sm-9 inner-addon right-addon">
		 <i class="glyphicon glyphicon-search" id="searchAdviser"></i>
		 <input type="text" id="adviserID" value="<?php echo $client->userFirstName." ".$client->userLastName?>" class="field form-control" readonly="readonly"/>
	     </div>                  
        </div>
	
	<div class="form-group  required">	    
	     <label for="retirementAge" class="col-sm-3 control-label">Member Expected Retirement Age</label>
	     <div class="col-sm-9">
		  <?php
		    $data = array(
		      'name'        => 'retirementAge',
	...
	<div class="form-group">
	   ...
	   <button name="save_cdetails" class="btn btn-success" value="Save"> Save and continue
